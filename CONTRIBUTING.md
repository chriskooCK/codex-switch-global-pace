# Contributing to codex-switch-global-pace

Thank you for improving `codex-switch-global-pace`. Contributions should be small enough to review and revert independently, and they must preserve local credential and profile safety.
...
Address review findings with focused commits. Maintainers own version changes, release tags, and GitHub Releases. A merged pull request is not itself a release.
