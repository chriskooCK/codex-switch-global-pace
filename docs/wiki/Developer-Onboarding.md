...
Contributors do not move release tags. Maintainers follow [the release process](https://github.com/chriskooCK/codex-switch-global-pace/blob/dev/docs/RELEASE.md), including independent review, local verification, branch CI, GitHub Actions artifact construction, checksum validation, and post-release smoke tests.
