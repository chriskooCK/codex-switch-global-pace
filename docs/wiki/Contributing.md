...
> Canonical contract: [CONTRIBUTING.md](https://github.com/chriskooCK/codex-switch-global-pace/blob/dev/CONTRIBUTING.md). GitHub surfaces that file in the pull-request flow; this page summarizes it.
...
Never attach credentials, auth files, personal account metadata, or unredacted debug output — in code, tests, issues, or pull requests. Read the full [contribution guidelines](https://github.com/chriskooCK/codex-switch-global-pace/blob/dev/CONTRIBUTING.md) before opening a pull request.
