...
pub fn healthy_pool() -> Vec<(String, Vec<Value>)> {
    vec![
        entry(
            "tok_healthy_a",
            vec![base_response("plus", 0.0, 18000, 10.0, 604800)],
        ),
        entry(
            "tok_healthy_b",
            vec![base_response("plus", 30.0, 14400, 15.0, 604800)],
        ),
        entry(
            "tok_healthy_c",
            vec![base_response("plus", 60.0, 10800, 20.0, 604800)],
        ),
    ]
}
...
pub fn team_priority() -> Vec<(String, Vec<Value>)> {
    vec![
        entry(
            "tok_team",
            vec![base_response("team", 50.0, 10800, 30.0, 604800)],
        ),
        entry(
            "tok_plus_a",
            vec![base_response("plus", 10.0, 16200, 5.0, 604800)],
        ),
        entry(
            "tok_plus_b",
            vec![base_response("plus", 20.0, 14400, 10.0, 604800)],
        ),
    ]
}
...
pub fn team_exhausted() -> Vec<(String, Vec<Value>)> {
    vec![
        entry(
            "tok_team_exhausted",
            vec![base_response("team", 100.0, 7200, 80.0, 604800)],
        ),
        entry(
            "tok_plus_c",
            vec![base_response("plus", 20.0, 14400, 15.0, 604800)],
        ),
        entry(
            "tok_plus_d",
            vec![base_response("plus", 45.0, 10800, 25.0, 604800)],
        ),
    ]
}
...
pub fn drain_window() -> Vec<(String, Vec<Value>)> {
    vec![
        entry(
            "tok_drain_a",
            vec![base_response("plus", 40.0, 1200, 20.0, 604800)],
        ),
        entry(
            "tok_drain_b",
            vec![base_response("plus", 30.0, 14400, 15.0, 604800)],
...
pub fn seven_day_crisis() -> Vec<(String, Vec<Value>)> {
    vec![
        entry(
            "tok_7d_crisis_a",
            vec![base_response("plus", 0.0, 18000, 95.0, 518400)],
        ),
        entry(
            "tok_7d_crisis_b",
            vec![base_response("plus", 50.0, 10800, 30.0, 604800)],
        ),
    ]
}
